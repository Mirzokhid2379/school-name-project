            ...
            <div className="container-fluid bg-light position-relative shadow">
                <nav className="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0 px-lg-5">
                    <a href="" className="navbar-brand font-weight-bold text-secondary" >
                        <i className=""></i>
                        <span className="text-primary">Your logo</span>
                    </a>
                    ...
                    <div className="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <a href="" className="btn btn-primary px-4">Join className</a>
                    </div>
                </nav>
            </div>
            ...
            <div className="container-fluid pt-5">
                <div className="container">
                    <div className="text-center pb-2">
                        <p className="section-title px-5"><span className="px-2">Popular classNamees</span></p>
                        <h1 className="mb-4">classNamees for Your Kids</h1>
                    </div>
                    <div className="row">
                        <div className="col-lg-4 mb-5">
                            <div className="card border-0 bg-light shadow-sm pb-2">
                                <img className="card-img-top mb-2" src="./assets/img/className-1.jpg" alt="" />
                                ...
                                <div className="card-footer bg-transparent py-4 px-5">
                                    ...
                                    <div className="row border-bottom">
                                        <div className="col-6 py-1 text-right border-right"><strong>className Time</strong></div>
                        ...
                        <div className="col-lg-4 mb-5">
                            <div className="card border-0 bg-light shadow-sm pb-2">
                                <img className="card-img-top mb-2" src="./assets/img/className-2.jpg" alt="" />
                                <div className="card-body text-center">
                        ...
                        <div className="col-lg-4 mb-5">
                            <div className="card border-0 bg-light shadow-sm pb-2">
                                <img className="card-img-top mb-2" src="./assets/img/className-3.jpg" alt="" />
                                <div className="card-body text-center">
                        ...
                        <div className="col-md-6 col-lg-3 text-center team mb-5">
                            <div className="position-relative overflow-hidden mb-4" >
                                ...
                                <div
                                    ...
                                    <a className="btn btn-outline-light text-center mr-2 px-0" 
                                        href="#"><i className="fab fa-twitter"></i></a>
                                    <a className="btn btn-outline-light text-center mr-2 px-0" 
                                        href="#"><i className="fab fa-facebook-f"></i></a>
                                    <a className="btn btn-outline-light text-center px-0" 
                    ...
                    <div className="owl-carousel testimonial-carousel">
                        <div className="testimonial-item px-3">
                            ...
                            <div className="d-flex align-items-center">
                                <img className="rounded-circle" src="./assets/img/testimonial-1.jpg"  alt="Image" />
                                <div className="pl-3">
                                    <h5>Parent Name</h5>
                                    <i>Profession</i>
                                </div>
                        ...
                        <div className="testimonial-item px-3">
                            ...
                            <div className="d-flex align-items-center">
                                <img className="rounded-circle" src="./assets/img/testimonial-2.jpg"  alt="Image" />
                                <div className="pl-3">
                                    <h5>Parent Name</h5>
                                    <i>Profession</i>
                                </div>
                        ...
                        <div className="testimonial-item px-3">
                            ...
                            <div className="d-flex align-items-center">
                                <img className="rounded-circle" src="./assets/img/testimonial-3.jpg"  alt="Image" />
                                <div className="pl-3">
                                    <h5>Parent Name</h5>
                                    <i>Profession</i>
                                </div>
                        ...
                        <div className="testimonial-item px-3">
                            ...
                            <div className="d-flex align-items-center">
                                <img className="rounded-circle" src="./assets/img/testimonial-4.jpg"  alt="Image" />
                                <div className="pl-3">
                                    <h5>Parent Name</h5>
                                    <i>Profession</i>
                                </div>
            ...
            <div className="container-fluid bg-secondary text-white mt-5 py-5 px-sm-3 px-md-5">
                <div className="row pt-5">
                    <div className="col-lg-3 col-md-6 mb-5">
                        <a href="" className="navbar-brand font-weight-bold text-primary m-0 mb-4 p-0">
                    ...
                    <div className="col-lg-3 col-md-6 mb-5">
                        ...
                        <div className="d-flex flex-column justify-content-start">
                            ...
                            <a className="text-white mb-2" href="#"><i className="fa fa-angle-right mr-2"></i>Our classNamees</a>
                            <a className="text-white mb-2" href="#"><i className="fa fa-angle-right mr-2"></i>Our Teachers</a>
                            <a className="text-white mb-2" href="#"><i className="fa fa-angle-right mr-2"></i>Our Blog</a>
                ...
                <div className="container-fluid pt-5">
                    <p className="m-0 text-center text-white">
                        ...
                        by
                        <a className="text-primary font-weight-bold" href="https://t.me/Mirzokhid_Mukhtorov">Mirzokhid</a>
                    </p>
                </div>
            </div>
